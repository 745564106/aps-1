...
<body>
<s:form namespace="/" action="department_saveOrUpdate" id="editForm" theme="simple">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<s:submit value="确定编辑" class="ui_input_btn01"/>
						&nbsp;<s:submit id="cancelbutton" value="重置" class="ui_input_btn01"/>
					</td>
				</tr>
			</table>
		</div>
