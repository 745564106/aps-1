				...
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<s:if test="employee.id==null">
						<tr>
							...
							<td class="ui_text_lt">
								<s:password name="employee.password" id="password"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<!-- 
							listKey:   作为option的value属性的值(把迭代出来的部门对象的id属性的值作为value)
							listValue: 作为option元素的内容(把迭代出来的部门对象的name属性的值作为显示的内容)
						 -->
							<s:select class="ui_select01" list="#depts"
								name="employee.dept.id" listKey="id" listValue="name"></s:select>
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							<table>
								<tr>
									...
									<td>
										<s:select name="employee.roles.id" list="employee.roles"
